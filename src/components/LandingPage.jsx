        ...
        <div className="flex flex-col ml-[15%]  overflow-y-auto h-full ">
          ...
          >
            <div className="w-[85%] mb-14 flex flex-col text-2xl font-extralight   gap-3 justify-center items-center text-white">
              <p className="flex mb-5  font-bold  ">About Me</p>
              <p>
          ...
          >
            <div className="w-[85%] mb-14 flex flex-col ml-[7%] text-2xl font-extralight  gap-3 justify-center   text-white">
                <p className="item-center font-bold flex justify-center">Education</p>
              <div className=" flex gap-2 flex-col pb-3">
                <p className="item-center font-bold flex justify-center">Technical Training</p>
              ...
              <div>
              <p className="item-center mb-5  font-bold  flex justify-center">Professional Training</p>
                <p className="mb-5 font-bold  ">Clemads Global Consulting Ltd</p>
